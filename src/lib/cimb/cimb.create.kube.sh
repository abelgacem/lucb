# purpose: buildah create an image that include the CLI: Kubeadm, Kubectl
# args: <BASE_IMAGE_SID>
luc_cimb_image_kuke_create()  {
  local lMSG_PURPOSE="buildah create an image that include the CLI: Kubeadm, Kubectl"  

...
# define envar
##
export luc_EV_CIMAGE_LUC_CORE_HOME=${luc_EV_LUC_CORE_HOME}
export luc_EV_CIMAGE_LUC_SRC_RELPATH=${luc_EV_LUC_CORE_BOOT_RELPATH}
export luc_EV_CIMAGE_OS_LIST=${luc_EV_LUC_CORE_OS_MANAGED}
##
export luc_EV_CIMAGE_OS_USER_SUDO='lisa' # linux sudo administrator
##
export luc_EV_CIMAGE_LABEL_KEY_SHELL=${luc_EV_CIM_LABEL_KEY_SHELL}
export luc_EV_CIMAGE_LABEL_KEY_OSNAME=${luc_EV_CIM_LABEL_KEY_OSNAME}
export luc_EV_CIMAGE_LABEL_KEY_IMAGE_ROOT="mx.image.src.00"
export luc_EV_CIMAGE_LABEL_KEY_IMAGE_CURRENT="mx.image.current"
export luc_EV_CIMAGE_LABEL_KEY_SERVER_PORT="mx.port.jekyll"
export luc_EV_CIMAGE_LABEL_VALUE_SERVER_PORT="4000"
##

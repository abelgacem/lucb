...
## Copy.Git  > File > User:Key.(Ssh,Pub):Ovh > to > /tmp then to vm:/tmp
lFileName=${gSshKeyPubOvhFileName}
mx-git-file-get conf main ssh/${lFileName} /tmp
mx-file-copy-remote /tmp/${lFileName} ${siVmName}

## Copy.Git  > File > Lib.Bash:User > to > /tmp then to vm:/tmp
lFileName=${gLibUserFileName}
mx-git-file-get code main lib/bash/${lFileName} /tmp
mx-file-copy-remote /tmp/${lFileName} ${siVmName}

## Copy.Git  > File > Lib.Bash:File > to > /tmp then to vm:/tmp

...
#sListPostToOpen="6783/tcp 10250/tcp 10255/tcp 30000-32767/tcp "
sListPostToOpen=" 10250/tcp 30000-32767/tcp"
## Debug
...
do
sAction="ssh ${siVmName} sudo firewall-cmd --permanent --remove-port=${stItemPort} -q"

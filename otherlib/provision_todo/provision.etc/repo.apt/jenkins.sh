...
# Step > Add > Key.apt
#sAction="ssh ${siVmName}  sudo wget -q -O - https://pkg.jenkins.io/debian/jenkins-ci.org.key | sudo apt-key add -"
sAction="ssh ${siVmName}  sudo wget -q -O - https://pkg.jenkins.io/debian-stable/jenkins.io.key | sudo apt-key add -"

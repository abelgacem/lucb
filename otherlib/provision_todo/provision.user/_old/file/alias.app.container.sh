...
alias   srcmxmi='source \${gUserLibFolderPath}/ctr.image.lib.sh'     # Manage Image
alias   srcmxmc='source \${gUserLibFolderPath}/ctr.container.lib.sh' # Manage Container
[ -z "\${PS1}" ] || { srcmxmi; srcmxmc; }
